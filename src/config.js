...
export const TOWERS = {
  fire: {
    id: "fire", name: "Fire", color: "#ff5a2a", glow: "#ffb070", cost: 20,
    levels: [
  ...
  water: {
    id: "water", name: "Water", color: "#3aa9ff", glow: "#9bd6ff", cost: 18,
    levels: [
  ...
  earth: {
    id: "earth", name: "Earth", color: "#8a6a2a", glow: "#d6b06a", cost: 22,
    levels: [
  ...
  air: {
    id: "air", name: "Air", color: "#bfe9ff", glow: "#ffffff", cost: 24,
    levels: [
  ...
  ether: {
    id: "ether", name: "Ether", color: "#a26bff", glow: "#d8b8ff", cost: 35,
    levels: [
